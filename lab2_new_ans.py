...
def topology():
    ...
    runDHCP(net) # if your dhcpd.conf is done, uncomment these two line 
...
def config(hosts, switches, routers, DHCPServer):
    ...
    #Config r1-r6 interface IP on your own


    # Host routing table default gateway configuration
    ...
    #Config r1-r4 routing table rules on your own
